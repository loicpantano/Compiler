...
tests:
	for a in $(INPUT2); do echo "Assemblage: " $${a}; python3 generation_code.py -nasm input/tests/$${a}.flo > output/tests/$${a}.nasm; nasm -f elf -g -F dwarf output/tests/$${a}.nasm; ld -m elf_i386 -o output/tests/$${a} output/tests/$${a}.o; rm output/tests/$${a}.o; done;
