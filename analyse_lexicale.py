...
class FloLexer(Lexer):
	...
	tokens = {TYPE, VRAI, FAUX, IDENTIFIANT, ENTIER, ECRIRE, LIRE, ET, OU, NON, SI, SINONSI, SINON, TANTQUE, RETOURNER, EGAL, DIFFERENT, INFERIEUR_OU_EGAL, SUPERIEUR_OU_EGAL, INFERIEUR, SUPERIEUR}
